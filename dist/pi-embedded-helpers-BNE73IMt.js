import { E as runExec, _ as DEFAULT_SOUL_FILENAME, b as ensureAgentWorkspace, f as DEFAULT_AGENTS_FILENAME, g as DEFAULT_IDENTITY_FILENAME, h as DEFAULT_HEARTBEAT_FILENAME, m as DEFAULT_BOOTSTRAP_FILENAME, n as resolveAgentConfig, p as DEFAULT_AGENT_WORKSPACE_DIR, u as resolveSessionAgentId, v as DEFAULT_TOOLS_FILENAME, y as DEFAULT_USER_FILENAME } from "./agent-scope-n6jqebe_.js";
...
import { c as SafeOpenError, i as getImageMetadata, l as openFileWithinRoot, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-C3xvxQ4C.js";
import { _ as getBlockedNetworkModeReason, n as loadConfig, o as writeConfigFile, t as createConfigIO } from "./config-Do3_2XKe.js";
...
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-DV5x8-Ny.js";
...
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-DcTT8D3L.js";
import { B as resolveAgentMainSessionKey, G as acquireSessionWriteLock, z as canonicalizeMainSessionAlias } from "./sessions-untMh16U.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-BOH9bz51.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-aAHX0meY.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-aAHX0meY.js")).closePlaywrightBrowserConnection();
		} catch {}
