...
import { T as parseDurationMs, i as loadConfig } from "./config-DNKWBHAH.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-ixfzwQFB.js";
...
import { r as resolveForwardCompatModel } from "./model-BwDKysjD.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./model-zHhV-7kQ.js";
...
import { f as openUrl } from "./onboard-helpers-pFN8AubL.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-C7taiuiw.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-BQEDRb9g.js";
import { n as logConfigUpdated } from "./logging-CPXozfuk.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-BcqN5T45.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-DNKWBHAH.js").then((n) => n.t);
	const { ensureAuthProfileStore } = await import("./model-selection-DooR7GQG.js").then((n) => n.pt);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-zHhV-7kQ.js");
