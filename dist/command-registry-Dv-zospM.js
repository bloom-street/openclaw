...
import { i as registerSubCliCommands, o as removeCommandByName, s as reparseProgramFromActionArgs } from "./register.subclis-_BQt839X.js";
...
const coreEntries = [
	{
		...
		register: async ({ program }) => {
			(await import("./register.setup-DF6yqY8X.js")).registerSetupCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.onboard-DKDoOjsM.js")).registerOnboardCommand(program);
		}
	},
	{
		commands: [{
	...
	},
	{
		...
		register: async ({ program }) => {
			(await import("./register.maintenance-AagzJhsP.js")).registerMaintenanceCommands(program);
		}
	},
	{
		commands: [{
