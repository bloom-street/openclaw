...
async function runCli(argv = process$1.argv) {
	...
	const { buildProgram } = await import("./program-DDh7yoe4.js");
	...
	if (primary) {
		...
		if (ctx) {
			const { registerCoreCliByName } = await import("./command-registry-Dv-zospM.js").then((n) => n.t);
			await registerCoreCliByName(program, ctx, primary, parseArgv);
		}
		const { registerSubCliByName } = await import("./register.subclis-_BQt839X.js").then((n) => n.a);
