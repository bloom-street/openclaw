...
import { C as buildAllowedModelSet, D as isCliProvider, L as resolveThinkingDefault, N as resolveConfiguredModelRef, O as modelKey, St as DEFAULT_PROVIDER, _ as ensureAuthProfileStore, bt as DEFAULT_CONTEXT_TOKENS, xt as DEFAULT_MODEL } from "./auth-profiles-zEppz1dW.js";
import { t as formatCliCommand } from "./command-format-ayFsmwwz.js";
import { d as resolveAgentIdFromSessionKey, l as normalizeAgentId, u as normalizeMainKey } from "./session-key-BRdRr5Ah.js";
import { a as resolveAgentModelPrimary, i as resolveAgentModelFallbacksOverride, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, x as ensureAgentWorkspace } from "./agent-scope-nWSUqWp6.js";
...
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-B-QGH1FX.js";
import { Bt as resolveAgentTimeoutMs, Cn as resolveOutboundTarget, Gt as registerAgentRunContext, H as getCliSessionId, Ht as emitAgentEvent, J as getRemoteSkillEligibility, Jt as AGENT_LANE_NESTED, On as runWithModelFallback, Ot as runEmbeddedPiAgent, U as setCliSessionId, Vt as clearAgentRunContext, W as runCliAgent, Xt as applyModelOverrideToSessionEntry, Yt as loadModelCatalog, lt as clearSessionAuthProfileOverride, mn as lookupContextTokens, q as resolveSendPolicy, st as getSkillsSnapshotVersion, ut as applyVerboseOverride, wn as resolveSessionDeliveryTarget } from "./loader-BC791mJC.js";
import { n as resolveSessionFilePath, o as resolveStorePath } from "./paths-C27OFaz1.js";
import { B as normalizeThinkLevel, F as formatXHighModelHint, H as normalizeVerboseLevel, P as formatThinkingLevels, W as supportsXHighThinking } from "./pi-embedded-helpers-DADHYT5R.js";
import { a as normalizeOutboundPayloadsForJson, i as normalizeOutboundPayloads, r as formatOutboundPayloadLog, t as deliverOutboundPayloads } from "./deliver-D2ePv4wG.js";
import { A as resolveSessionResetType, D as evaluateSessionFreshness, E as resolveSessionKey, F as resolveExplicitAgentSessionKey, O as resolveChannelResetConfig, T as normalizeAccountId, d as loadSessionStore, g as updateSessionStore, k as resolveSessionResetPolicy } from "./sandbox-ClPjss8U.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-7JHw-ZEf.js";
import { l as deriveSessionTotalTokens, u as hasNonzeroUsage } from "./session-cost-usage-72xDw9gJ.js";
import { t as createDefaultDeps } from "./deps-yYQM2M7J.js";
