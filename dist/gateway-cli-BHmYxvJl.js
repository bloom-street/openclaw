...
import { r as resolveMemorySearchConfig } from "./manager-CoPj1rZi.js";
...
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-BsxoaEGv.js";
...
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-Bq45DoOa.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-DNASItKU.js";
...
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CKhMw4Rj.js";
...
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-Bh9VAZlp.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-qebOwBBs.js");
