...
import { g as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-nvzGbP5e.js";
import { p as restoreTerminalState } from "./subsystem-C5Sd3JES.js";
...
import { b as waitForGatewayReachable, f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint } from "./onboard-helpers-pFN8AubL.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-BNX7A2z9.js").then((n) => n.r);
