import { Dt as theme, Et as isRich, Ft as tryParseLogLevel, Nt as ALLOWED_LOG_LEVELS, X as escapeRegExp, an as getCommandPath, dn as hasHelpOrVersion, fn as hasRootVersionAlias, ln as getVerboseFlag, r as isTruthyEnvValue, un as hasFlag, v as defaultRuntime, xt as setVerbose } from "./entry.js";
import "./auth-profiles-D22D1tnt.js";
import { n as replaceCliName, r as resolveCliName } from "./command-format-_PO7rvrJ.js";
...
import { n as resolveCliChannelOptions } from "./channel-options-SobfoQxf.js";
import { t as getSubCliCommandsWithSubcommands } from "./register.subclis-niOAR97A.js";
import { a as registerProgramCommands, r as getCoreCliCommandsWithSubcommands } from "./command-registry-DAi0V_4N.js";
import { r as setProgramContext } from "./program-context-DMkrV4MF.js";
import { t as forceFreePort } from "./ports-BtBq1142.js";
import { n as formatCliBannerLine, r as hasEmittedCliBanner, t as emitCliBanner } from "./banner-1TkdYW49.js";
...
function registerPreActionHooks(program, programVersion) {
	program.hook("preAction", async (_thisCommand, actionCommand) => {
		...
		const { ensureConfigReady } = await import("./config-guard-Dp1RGI5c.js").then((n) => n.t);
		await ensureConfigReady({
			runtime: defaultRuntime,
			commandPath
		});
		if (PLUGIN_REQUIRED_COMMANDS.has(commandPath[0])) {
			const { ensurePluginRegistryLoaded } = await import("./plugin-registry-BG8E1dle.js").then((n) => n.n);
