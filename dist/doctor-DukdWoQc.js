...
import { E as getModelRefStatus, F as resolveHooksGmailModel, N as resolveConfiguredModelRef, St as DEFAULT_PROVIDER, Tt as CODEX_CLI_PROFILE_ID, _ as ensureAuthProfileStore, f as repairOAuthProfileIdMismatch, o as resolveProfileUnusableUntilForDisplay, s as resolveApiKeyForProfile, wt as CLAUDE_CLI_PROFILE_ID, xt as DEFAULT_MODEL, y as updateAuthProfileStoreWithLock } from "./auth-profiles-OdU3_yD3.js";
import { t as formatCliCommand } from "./command-format-ayFsmwwz.js";
import { i as buildAgentMainSessionKey, l as normalizeAgentId, r as DEFAULT_MAIN_KEY, t as DEFAULT_ACCOUNT_ID } from "./session-key-BRdRr5Ah.js";
import { b as sleep, m as resolveHomeDir$1, y as shortenHomePath } from "./utils-kK6fjsN0.js";
...
import { c as resolveDefaultAgentId, d as DEFAULT_AGENTS_FILENAME, s as resolveAgentWorkspaceDir } from "./agent-scope-BPbP3nUY.js";
import { c as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, u as OpenClawSchema } from "./config-DWFc1sJR.js";
import { d as formatPortDiagnostics, l as inspectPortUsage } from "./chrome-C-gAdv-3.js";
import { Ht as resolveGatewayBindHost, Rt as isLoopbackHost } from "./client-Dzx1FlLz.js";
import { i as resolveGatewayAuth } from "./auth-DVIDxtSd.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-AlDhuZZQ.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-D1MC6c50.js";
import { n as listChannelPlugins } from "./plugins-pICDrOYL.js";
import { Yt as loadModelCatalog, _ as randomToken, a as applyWizardMetadata, h as printWizardHeader, t as loadOpenClawPlugins, u as guardCancel } from "./loader-D1fSA4zX.js";
...
import { a as resolveSessionTranscriptsDirForAgent, n as resolveSessionFilePath, o as resolveStorePath } from "./paths-C27OFaz1.js";
import { I as resolveMainSessionKey, N as canonicalizeMainSessionAlias, W as resolveSandboxScope, d as loadSessionStore, et as DEFAULT_SANDBOX_BROWSER_IMAGE, m as saveSessionStore, nt as DEFAULT_SANDBOX_IMAGE, tt as DEFAULT_SANDBOX_COMMON_IMAGE } from "./sandbox-BE3PG9bB.js";
import { n as isWSLEnv, t as isWSL } from "./wsl-CPEOavWT.js";
...
import { i as readChannelAllowFromStore } from "./pairing-store-C9HZP3A3.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CSSVsvAH.js";
import { a as gatewayInstallErrorHint, d as renderSystemNodeWarning, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, p as resolveSystemNodeInfo, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-D359XoF_.js";
...
import { a as renderGatewayServiceCleanupHints, i as findExtraGatewayServices, n as auditGatewayServiceConfig, o as readLastGatewayErrorLine, r as needsNodeRuntimeMigration, t as SERVICE_AUDIT_CODES } from "./service-audit-nIA2TVUt.js";
import { i as resolveControlUiDistIndexPathForRoot, l as healthCommand, r as resolveControlUiDistIndexHealth, t as formatHealthCheckFailure } from "./health-format-CKRwfpfu.js";
import { f as doctorShellCompletion, t as runGatewayUpdate } from "./update-runner-C6yxWJkC.js";
import { n as logConfigUpdated } from "./logging-DJkpOGZF.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-DJBHAFFn.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-qAauFdxn.js";
