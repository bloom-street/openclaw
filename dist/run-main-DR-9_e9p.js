...
import { Mt as installUnhandledRejectionHandler } from "./loader-uxXm88IB.js";
...
import { n as ensurePluginRegistryLoaded } from "./command-options-BP57Ofwj.js";
import { a as getCommandPath, c as getPrimaryCommand, d as hasHelpOrVersion } from "./register.subclis-CurIFmsr.js";
import "./completion-cli-CYvvCJ5Z.js";
import "./gateway-rpc-Cu95hbYd.js";
import "./deps-DvWi2tqQ.js";
...
import "./onboard-skills-BTX90M4E.js";
import "./health-format-Z58V2d8u.js";
import "./update-runner-Dy5BfJjD.js";
import "./github-copilot-auth-B5hypsrE.js";
import "./logging-DJkpOGZF.js";
import "./hooks-status-Cn8_mGAg.js";
import "./status-FT_SMSAu.js";
import "./skills-status-DJBHAFFn.js";
import "./tui-Co3naBo0.js";
import "./agent-DL1pqh28.js";
import "./node-service-u8g85nD3.js";
import "./auth-health-BKjcLUpk.js";
import { a as findRoutedCommand, n as emitCliBanner, t as ensureConfigReady } from "./config-guard-DijIMOwp.js";
import "./help-format-CUnac_bT.js";
import "./configure-DP9dULBB.js";
import "./systemd-linger-CDo2UbHM.js";
import "./doctor-oOGsYZw_.js";
...
async function runCli(argv = process$1.argv) {
	...
	const { buildProgram } = await import("./program-CbxISjdi.js");
	...
	if (primary) {
		const { registerSubCliByName } = await import("./register.subclis-CurIFmsr.js").then((n) => n.i);
