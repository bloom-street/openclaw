...
const entries = [
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./gateway-cli-CyYtLkZf.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./models-cli-BbCG801Z.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./hooks-cli-CvgQYDwO.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			const { registerPluginCliCommands } = await import("./cli--aWvA8NO.js");
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./plugins-cli-B6P2-zSR.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli--aWvA8NO.js");
			registerPluginCliCommands(program, await loadConfig());
		}
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./channels-cli-C9YqfCq_.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./update-cli-Dr6XQK_O.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./completion-cli-DY6dSGbv.js").then((n) => n.n)).registerCompletionCli(program);
		}
	}
];
...
const coreEntries = [
	{
		...
		register: async ({ program }) => {
			(await import("./register.setup-CgkKjOZU.js")).registerSetupCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.onboard-FTf4ikw4.js")).registerOnboardCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.configure-DAlz92Lm.js")).registerConfigureCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./config-cli-CTWOkUbn.js")).registerConfigCli(program);
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.maintenance-6yU8yhop.js")).registerMaintenanceCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.message-ck2f7iST.js")).registerMessageCommands(program, ctx);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./memory-cli-BMzOv8ao.js").then((n) => n.t)).registerMemoryCli(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.agent-DXnOGl7H.js")).registerAgentCommands(program, { agentChannelOptions: ctx.agentChannelOptions });
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.status-health-sessions-BaA7RNrd.js")).registerStatusHealthSessionsCommands(program);
		}
	},
	{
		commands: [{
