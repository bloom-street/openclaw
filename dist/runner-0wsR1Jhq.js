import { m as resolveAgentModelPrimaryValue, p as resolveAgentModelFallbackValues } from "./agent-scope-Cn3C2ptS.js";
...
import { _ as runExec } from "./workspace-CqHof6MR.js";
import { E as resolveApiKeyForProvider, T as requireApiKey, X as resolveOpenClawAgentDir, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-wi8K54ui.js";
import { t as normalizeChatType } from "./chat-type-C4pAlbsI.js";
import { _ as kindFromMime, d as detectMime, h as isAudioFileName, p as getFileExtension } from "./image-ops-BeXtPfpf.js";
import { d as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, f as isInboundPathAllowed, m as resolveIMessageAttachmentRoots, n as loadConfig, p as mergeInboundPathRoots } from "./config-BB8kMxZU.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-CLOK6lEA.js";
...
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-B9dknNG2.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-CeTeRfso.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
