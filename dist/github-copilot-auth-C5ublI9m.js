...
import { ut as loadOpenClawPlugins } from "./reply-DptDUVRg.js";
import { l as normalizeAgentId } from "./session-key-CUWZSMYQ.js";
import { t as listAgentIds } from "./agent-scope-BimPHsgV.js";
import { A as SYNTHETIC_BASE_URL, D as VENICE_DEFAULT_MODEL_REF, E as VENICE_BASE_URL, J as buildCloudflareAiGatewayModelDefinition, M as SYNTHETIC_MODEL_CATALOG, N as buildSyntheticModelDefinition, O as VENICE_MODEL_CATALOG, Tt as DEFAULT_PROVIDER, Y as resolveCloudflareAiGatewayBaseUrl, _ as QIANFAN_DEFAULT_MODEL_ID, _t as resolveOpenClawAgentDir, b as buildXiaomiProvider, dt as upsertAuthProfile, ft as ensureAuthProfileStore, g as QIANFAN_BASE_URL, j as SYNTHETIC_DEFAULT_MODEL_REF, k as buildVeniceModelDefinition, m as resolveModelRefFromString, q as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, r as buildModelAliasIndex, s as normalizeProviderId, v as XIAOMI_DEFAULT_MODEL_ID, y as buildQianfanProvider } from "./model-selection-D3KJIAFQ.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import { c as writeConfigFile, o as readConfigFileSnapshot } from "./config-CuE2AFLW.js";
import { r as isWSLEnv } from "./dispatcher-C6dI7SNB.js";
import { r as stylePromptTitle } from "./prompt-style-DjZDxcFg.js";
