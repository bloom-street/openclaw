...
const entries = [
	...
	},
	{
		...
		register: async (program) => {
			(await import("./gateway-cli-HZ9dxzev.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
		...
		register: async (program) => {
			(await import("./daemon-cli-BV6xFMSq.js").then((n) => n.t)).registerDaemonCli(program);
		}
	},
	{
		name: "logs",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./models-cli-Dxx7UZWi.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./sandbox-cli-0mnsq_K5.js")).registerSandboxCli(program);
		}
	},
	{
		name: "tui",
		...
		register: async (program) => {
			(await import("./tui-cli-BwCGtCPA.js")).registerTuiCli(program);
		}
	},
	{
		name: "cron",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./hooks-cli-D07itMo9.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./plugins-cli-BrVGHY4M.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-DECiVSgx.js");
			registerPluginCliCommands(program, await loadConfig());
		}
	},
	{
		...
		register: async (program) => {
			(await import("./channels-cli-DOLweM8h.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./security-cli-CBuPskgR.js")).registerSecurityCli(program);
		}
	},
	{
		name: "skills",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./update-cli-Cr5pi9td.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		register: async (program) => {
			(await import("./completion-cli-Cnvh4nr5.js").then((n) => n.n)).registerCompletionCli(program);
		}
	}
];
