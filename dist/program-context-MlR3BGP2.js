...
const entries = [
	{
		...
		register: async (program) => {
			(await import("./acp-cli-1fwwfcZq.js")).registerAcpCli(program);
		}
	},
	{
		name: "gateway",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./gateway-cli-DZVH_7Zo.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./models-cli-CeCLombF.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./sandbox-cli-CF9lieVC.js")).registerSandboxCli(program);
		}
	},
	{
		name: "tui",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./tui-cli-C51QM2gg.js")).registerTuiCli(program);
		}
	},
	{
		name: "cron",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./hooks-cli-mf4xg98e.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			const { registerPluginCliCommands } = await import("./cli-x2J0ervE.js");
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./plugins-cli-F9yoyaN9.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-x2J0ervE.js");
			registerPluginCliCommands(program, await loadConfig());
		}
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./channels-cli-fADG4Vvf.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./security-cli-C_joPdWv.js")).registerSecurityCli(program);
		}
	},
	{
		name: "skills",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./update-cli-DGgUPf58.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./completion-cli-RI3EHmre.js").then((n) => n.n)).registerCompletionCli(program);
		}
	}
];
...
const coreEntries = [
	{
		...
		register: async ({ program }) => {
			(await import("./register.setup-DrLrCkm0.js")).registerSetupCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.onboard-Dtz1GHWs.js")).registerOnboardCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.configure-BZE5KD6x.js")).registerConfigureCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./config-cli--2QWWUfI.js")).registerConfigCli(program);
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.maintenance-Cxuz-i2j.js")).registerMaintenanceCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.message-CuPeuudd.js")).registerMessageCommands(program, ctx);
		}
	},
	{
		commands: [{
	...
	},
	{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.agent-C4JHbWAQ.js")).registerAgentCommands(program, { agentChannelOptions: ctx.agentChannelOptions });
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.status-health-sessions-DaLlfevR.js")).registerStatusHealthSessionsCommands(program);
		}
	},
	{
		commands: [{
