...
import { n as loadConfig, o as writeConfigFile, t as createConfigIO, z as getBlockedNetworkModeReason } from "./config-uHVtgeU4.js";
import { i as parseBooleanValue, t as formatCliCommand } from "./command-format-DoSIFR_b.js";
import { E as runExec, _ as DEFAULT_SOUL_FILENAME, b as ensureAgentWorkspace, f as DEFAULT_AGENTS_FILENAME, g as DEFAULT_IDENTITY_FILENAME, h as DEFAULT_HEARTBEAT_FILENAME, m as DEFAULT_BOOTSTRAP_FILENAME, n as resolveAgentConfig, p as DEFAULT_AGENT_WORKSPACE_DIR, u as resolveSessionAgentId, v as DEFAULT_TOOLS_FILENAME, y as DEFAULT_USER_FILENAME } from "./agent-scope-C7lDXLcL.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-DxNipVio.js";
import { b as openFileWithinRoot, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, y as SafeOpenError } from "./image-ops-CJzX8elj.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-uaytAzph.js";
import { a as syncSkillsToWorkspace, h as safeEqualSecret, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-CtkhJHXI.js";
...
import { A as acquireSessionWriteLock, B as canonicalizeMainSessionAlias, V as resolveAgentMainSessionKey } from "./sessions-BQRS1nKH.js";
import { i as saveMediaBuffer, t as ensureMediaDir } from "./store-hRWN63IF.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-YoVlpmVs.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-YoVlpmVs.js")).closePlaywrightBrowserConnection();
		} catch {}
