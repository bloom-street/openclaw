...
import { B as resolveUserPath, c as CHANNEL_IDS, ft as resolvePreferredOpenClawTmpDir, i as defaultRuntime, q as truncateUtf16Safe, t as createSubsystemLogger } from "./subsystem-loAAXGlc.js";
import { n as loadConfig, o as writeConfigFile, t as createConfigIO, z as getBlockedNetworkModeReason } from "./config-CizIEHaM.js";
import { i as parseBooleanValue, t as formatCliCommand } from "./command-format-DI57or3f.js";
import { E as runExec, _ as DEFAULT_SOUL_FILENAME, b as ensureAgentWorkspace, f as DEFAULT_AGENTS_FILENAME, g as DEFAULT_IDENTITY_FILENAME, h as DEFAULT_HEARTBEAT_FILENAME, m as DEFAULT_BOOTSTRAP_FILENAME, n as resolveAgentConfig, p as DEFAULT_AGENT_WORKSPACE_DIR, u as resolveSessionAgentId, v as DEFAULT_TOOLS_FILENAME, y as DEFAULT_USER_FILENAME } from "./agent-scope-CdRMHY-e.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-BCGY_vDh.js";
import { b as openFileWithinRoot, i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS, y as SafeOpenError } from "./image-ops-BFqsv6C1.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-1es22JxN.js";
import { a as syncSkillsToWorkspace, h as safeEqualSecret, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-Dh-eevlN.js";
...
import { A as acquireSessionWriteLock, B as canonicalizeMainSessionAlias, V as resolveAgentMainSessionKey } from "./sessions-DO4EfGhu.js";
import { i as saveMediaBuffer, t as ensureMediaDir } from "./store-DpxE4Wbf.js";
...
const CORE_TOOL_DEFINITIONS = [
	...
	{
		id: "memory_save_fact",
		label: "memory_save_fact",
		description: "Save a structured fact",
		sectionId: "memory",
		profiles: ["coding"],
		includeInOpenClawGroup: true
	},
	{
		id: "memory_search_facts",
		label: "memory_search_facts",
		description: "Search structured facts",
		sectionId: "memory",
		profiles: ["coding"],
		includeInOpenClawGroup: true
	},
	{
		id: "memory_update_core",
		label: "memory_update_core",
		description: "Update core memory facts",
		sectionId: "memory",
		profiles: ["coding"],
		includeInOpenClawGroup: true
	},
	{
		...
		description: "Consolidate and deduplicate memory facts",
		sectionId: "memory",
		profiles: ["coding"],
		includeInOpenClawGroup: true
	},
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-yfRTrzlE.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-yfRTrzlE.js")).closePlaywrightBrowserConnection();
		} catch {}
