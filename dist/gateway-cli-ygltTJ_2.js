...
import { S as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads, w as runGlobalGatewayStopSafely } from "./deliver-9xjVesO1.js";
...
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-g9sAo3Nf.js";
import { i as listCoreToolSections, n as PROFILE_OPTIONS, o as resolveCoreToolProfiles } from "./tool-catalog-DfeHwYkI.js";
...
import { S as extractTextFromChatContent } from "./image-CKyFOMEz.js";
import "./tool-display-Dgs8w-fd.js";
import { d as registerUnhandledRejectionHandler } from "./runner-BRV4W8vJ.js";
...
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-3Jqks9s8.js";
...
import { c as resolveNodeCommandAllowlist, l as probeGateway, n as collectEnabledInsecureOrDangerousFlags, s as isNodeCommandAllowed } from "./audit-DKNYyYXg.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-CIYDqO0C.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-BifZPjoS.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-C3hJk35j.js";
...
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-CPDh0U9d.js";
...
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-U8nWf84Q.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-CpdVMS_9.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./deliver-9xjVesO1.js").then((n) => n.n);
