...
import { B as getLogger, C as getActivePluginRegistry, I as colorize, L as isRich, M as setVerbose, R as theme, V as getResolvedLoggerSettings, a as setConsoleTimestampPrefix, c as defaultRuntime, h as DEFAULT_CHAT_CHANNEL, i as setConsoleSubsystemFilter, n as runtimeForLogger, p as CHANNEL_IDS, t as createSubsystemLogger, z as getChildLogger } from "./subsystem-DPnkvS73.js";
import { _ as resolveUserPath, b as shortenHomePath, c as ensureDir, r as clamp, t as CONFIG_DIR, w as truncateUtf16Safe } from "./utils-DC1T2Vz-.js";
import { B as normalizeElevatedLevel, H as normalizeThinkLevel, I as formatThinkingLevels, K as supportsXHighThinking, L as formatXHighModelHint, U as normalizeUsageDisplay, V as normalizeReasoningLevel, W as normalizeVerboseLevel } from "./pi-embedded-helpers-BvbxDxSx.js";
import { $ as inferLegacyName, $n as getTtsProvider, $t as getSkillsSnapshotVersion, An as runSubagentAnnounceFlow, Ar as DEFAULT_INPUT_FILE_MAX_BYTES, B as consumeGatewaySigusr1RestartAuthorization, Br as extractFileContentFromSource, Bt as getRemoteSkillEligibility, C as readSessionMessages, Cr as applyModelOverrideToSessionEntry, Dn as isAbortTrigger, Dr as isSystemEventContextChanged, E as stripEnvelopeFromMessages, En as formatZonedTimestamp, Er as enqueueSystemEvent, F as resetDirectoryCache, Fn as onAgentEvent, Fr as DEFAULT_INPUT_MAX_REDIRECTS, G as formatDoctorNonInteractiveHint, Gn as resolveUserTimeFormat, Gt as setSkillsRemoteRegistry, H as scheduleGatewaySigusr1Restart, Hn as resolveAgentIdentity, Hr as normalizeMimeList, Ht as recordRemoteNodeInfo, In as registerAgentRunContext, Ir as DEFAULT_INPUT_PDF_MAX_PAGES, It as CONTROL_UI_AVATAR_PREFIX, J as summarizeRestartSentinel, Jn as createInternalHookEvent, Jt as rejectNodePairing, K as formatRestartSentinelMessage, Kn as resolveUserTimezone, Kt as approveNodePairing, L as runWithModelFallback, Lr as DEFAULT_INPUT_PDF_MAX_PIXELS, Lt as buildControlUiAvatarUrl, M as resolveOutboundTarget, Mn as clearAgentRunContext, Mr as DEFAULT_INPUT_FILE_MIMES, N as resolveSessionDeliveryTarget, Nn as emitAgentEvent, Nr as DEFAULT_INPUT_IMAGE_MAX_BYTES, O as ensureOutboundSessionEntry, On as stopSubagentsForRequester, Pn as getAgentRunContext, Pr as DEFAULT_INPUT_IMAGE_MIMES, Q as normalizeCronJobPatch, Qn as OPENAI_TTS_VOICES, Qt as verifyNodeToken, Rn as normalizePollInput, Rr as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, Rt as normalizeControlUiBasePath, S as capArrayByJsonBytes, T as resolveSessionTranscriptCandidates, Tn as createReplyDispatcher, Tr as parseVerboseOverride, Tt as handleReset, U as setGatewaySigusr1RestartPolicy, Ut as refreshRemoteBinsForConnectedNodes, V as isGatewaySigusr1RestartExternallyAllowed, Vr as extractImageContentFromSource, Vt as primeRemoteSkillsCache, W as consumeRestartSentinel, Wn as formatUserTime, Wr as resolveAgentTimeoutMs, Wt as refreshRemoteNodeBins, X as writeRestartSentinel, Xn as triggerInternalHook, Xt as requestNodePairing, Yn as registerInternalHook, Yt as renamePairedNode, Z as normalizeCronJobCreate, Zn as OPENAI_TTS_MODELS, Zt as updatePairedNodeMetadata, _ as loadCombinedSessionStoreForGateway, _n as onHeartbeatEvent, ar as resolveTtsPrefsPath, b as resolveSessionModelRef, br as stripHeartbeatToken, c as clearSessionQueues, cn as createReplyPrefixOptions, cr as setTtsProvider, d as waitForEmbeddedPiRunEnd, dn as registerUnhandledRejectionHandler, dr as setCommandLaneConcurrency, dt as loadProviderUsageSummary, en as registerSkillsChangeListener, er as isTtsEnabled, et as normalizeOptionalAgentId, fr as CommandLane, g as listSessionsFromStore, gn as getLastHeartbeatEvent, gr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, gt as handleSlackHttpRequest, h as listAgentsForGateway, hr as isDiagnosticsEnabled, i as runCliAgent, in as isExternalHookSession, ir as resolveTtsConfig, it as migrateLegacyCronPayload, jr as DEFAULT_INPUT_FILE_MAX_CHARS, k as resolveOutboundSessionRoute, kn as initSubagentRegistry, kr as loadModelCatalog, l as runEmbeddedPiAgent, ln as normalizeGroupActivation, lr as textToSpeech, lt as getPluginToolMeta, m as resolveAnnounceTargetFromKey, mn as resolveHeartbeatVisibility, mr as stopDiagnosticHeartbeat, n as getCliSessionId, nn as detectSuspiciousPatterns, nr as resolveTtsApiKey, nt as normalizePayloadToSystemText, o as normalizeSendPolicy, or as resolveTtsProviderOrder, p as createOpenClawTools, pn as buildHistoryContextFromEntries, pr as startDiagnosticHeartbeat, qn as clearInternalHooks, qt as listNodePairing, r as setCliSessionId, rn as getHookType, rr as resolveTtsAutoMode, rt as normalizeRequiredName, s as resolveSendPolicy, sr as setTtsEnabled, st as requestHeartbeatNow, tn as buildSafeExternalPrompt, tr as isTtsProviderConfigured, tt as normalizeOptionalText, u as abortEmbeddedPiRun, ut as loadOpenClawPlugins, v as loadSessionEntry, w as readSessionPreviewItemsFromTranscript, wn as dispatchInboundMessage, wr as applyVerboseOverride, x as archiveFileOnDisk, xn as getChannelActivity, xr as lookupContextTokens, y as resolveGatewaySessionStoreTarget, z as authorizeGatewaySigusr1Restart, zr as DEFAULT_INPUT_TIMEOUT_MS, zt as resolveAssistantAvatarUrl } from "./reply-CUwCtVzh.js";
import { _ as isSubagentSessionKey, d as resolveAgentIdFromSessionKey, i as buildAgentMainSessionKey, l as normalizeAgentId, m as toAgentRequestSessionKey, n as DEFAULT_AGENT_ID, t as DEFAULT_ACCOUNT_ID, u as normalizeMainKey, v as parseAgentSessionKey } from "./session-key-CUWZSMYQ.js";
import { a as logDebug, c as logWarn, n as runExec, t as runCommandWithTimeout } from "./exec-DFOtZbI0.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-93W6UrUK.js";
import { T as resolveWorkspaceTemplateDir, _ as DEFAULT_MEMORY_FILENAME, b as DEFAULT_USER_FILENAME, c as resolveDefaultAgentId, d as DEFAULT_AGENTS_FILENAME, g as DEFAULT_MEMORY_ALT_FILENAME, h as DEFAULT_IDENTITY_FILENAME, i as resolveAgentModelFallbacksOverride, l as resolveSessionAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, p as DEFAULT_BOOTSTRAP_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, v as DEFAULT_SOUL_FILENAME, w as resolveDefaultAgentWorkspaceDir, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME } from "./agent-scope-TEKvyC71.js";
import { Ct as DEFAULT_CONTEXT_TOKENS, Tt as DEFAULT_PROVIDER, a as isCliProvider, d as resolveConfiguredModelRef, f as resolveDefaultModelForAgent, h as resolveThinkingDefault, i as getModelRefStatus, l as resolveAllowedModelRef, p as resolveHooksGmailModel, wt as DEFAULT_MODEL, yt as normalizeSecretInput } from "./model-selection-BSjmwr-2.js";
import "./github-copilot-token-BW-SEg7E.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import "./boolean-BgXe2hyu.js";
import { n as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-B5YXooWp.js";
import { A as resolveSubagentMaxConcurrent, T as applyLegacyMigrations, a as parseConfigJson5, c as writeConfigFile, i as loadConfig, j as VERSION, k as resolveAgentMaxConcurrent, l as validateConfigObjectWithPlugins, n as migrateLegacyConfig, o as readConfigFileSnapshot, r as createConfigIO, s as resolveConfigSnapshotHash, u as OpenClawSchema } from "./config-DE7StXS1.js";
import { o as isTestDefaultMemorySlotDisabled } from "./manifest-registry-D9xpkqNV.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-Dyk3sGJx.js";
...
import { d as inspectPortUsage, l as ensurePortAvailable, p as formatPortDiagnostics } from "./chrome-DI--0Dvj.js";
import { d as hasBinary, i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-BpAg7sFB.js";
import { c as saveMediaBuffer, l as detectMime } from "./routes-DPxZWkgO.js";
import { n as formatErrorMessage } from "./errors-BTWUcKZ6.js";
import { n as movePathToTrash } from "./server-context-vpTNR47p.js";
import { t as rawDataToString } from "./ws-6_dFpKWQ.js";
import { f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-DDb2JxXt.js";
import "./logging-kuFzZMsG.js";
import "./accounts-DfGQnxc5.js";
import { a as resolveSessionTranscriptsDirForAgent, n as resolveSessionFilePath, o as resolveStorePath, r as resolveSessionTranscriptPath } from "./paths-BuajeM4x.js";
import "./redact-CVRUv382.js";
import "./tool-display-Ie79i5v6.js";
import { o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-DZFwPB6N.js";
import { i as getMachineDisplayName, t as createBrowserRouteDispatcher } from "./dispatcher-D5WOyG_M.js";
import "./manager-ALweQy23.js";
import "./sqlite-B5oxikhe.js";
import "./tui-formatters-D76y1ElX.js";
import { $ as validateNodeDescribeParams, A as validateConfigSchemaParams, At as validateWizardCancelParams, B as validateDevicePairApproveParams, C as validateChatAbortParams, Ct as validateSkillsStatusParams, D as validateConfigApplyParams, Dt as validateWakeParams, E as validateChatSendParams, Et as validateUpdateRunParams, F as validateCronRemoveParams, Ft as ErrorCodes, G as validateExecApprovalRequestParams, H as validateDevicePairRejectParams, I as validateCronRunParams, It as errorShape, J as validateExecApprovalsNodeGetParams, K as validateExecApprovalResolveParams, L as validateCronRunsParams, M as validateConnectParams, Mt as validateWizardStartParams, N as validateCronAddParams, Nt as validateWizardStatusParams, O as validateConfigGetParams, Ot as validateWebLoginStartParams, P as validateCronListParams, Pt as PROTOCOL_VERSION, Q as validateModelsListParams, R as validateCronStatusParams, Rt as parseSessionLabel, S as validateChannelsStatusParams, St as validateSkillsInstallParams, T as validateChatInjectParams, Tt as validateTalkModeParams, U as validateDeviceTokenRevokeParams, Ut as normalizeDevicePublicKeyBase64Url, V as validateDevicePairListParams, Vt as deriveDeviceIdFromPublicKey, W as validateDeviceTokenRotateParams, Wt as verifyDeviceSignature, X as validateExecApprovalsSetParams, Y as validateExecApprovalsNodeSetParams, Z as validateLogsTailParams, _ as validateAgentsFilesListParams, _t as validateSessionsPreviewParams, at as validateNodePairListParams, b as validateAgentsUpdateParams, bt as validateSessionsUsageParams, c as resolveGatewayListenHosts, ct as validateNodePairVerifyParams, d as validateAgentIdentityParams, dt as validateRequestFrame, et as validateNodeEventParams, f as validateAgentParams, ft as validateSendParams, g as validateAgentsFilesGetParams, gt as validateSessionsPatchParams, h as validateAgentsDeleteParams, ht as validateSessionsListParams, it as validateNodePairApproveParams, j as validateConfigSetParams, jt as validateWizardNextParams, k as validateConfigPatchParams, kt as validateWebLoginWaitParams, lt as validateNodeRenameParams, m as validateAgentsCreateParams, mt as validateSessionsDeleteParams, n as isLoopbackHost$2, nt as validateNodeInvokeResultParams, o as resolveGatewayBindHost, ot as validateNodePairRejectParams, p as validateAgentWaitParams, pt as validateSessionsCompactParams, q as validateExecApprovalsGetParams, r as isTrustedProxyAddress, rt as validateNodeListParams, s as resolveGatewayClientIp, st as validateNodePairRequestParams, t as isLoopbackAddress, tt as validateNodeInvokeParams, u as formatValidationErrors, ut as validatePollParams, v as validateAgentsFilesSetParams, vt as validateSessionsResetParams, w as validateChatHistoryParams, wt as validateSkillsUpdateParams, x as validateChannelsLogoutParams, xt as validateSkillsBinsParams, y as validateAgentsListParams, yt as validateSessionsResolveParams, z as validateCronUpdateParams, zt as buildDeviceAuthPayload } from "./net-BS4Hcnhx.js";
import { n as pickPrimaryTailnetIPv6, t as pickPrimaryTailnetIPv4 } from "./tailnet-D5wOWpOX.js";
import { n as callGateway, o as loadGatewayTlsRuntime$1 } from "./call-Ch49AeEh.js";
...
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy, t as filterToolsByPolicy } from "./pi-tools.policy-_2OxbWhe.js";
import "./prompt-style-DjZDxcFg.js";
import "./pairing-labels-4Uikaa-0.js";
import { i as loadSessionUsageTimeSeries, l as deriveSessionTotalTokens, n as loadCostUsageSummary, r as loadSessionCostSummary, t as discoverAllSessions, u as hasNonzeroUsage } from "./session-cost-usage-BLg4_A0k.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-hd37en6b.js";
import { c as normalizeExecApprovals, g as saveExecApprovals, l as readExecApprovalsSnapshot, m as resolveExecApprovalsSocketPath, r as ensureExecApprovals } from "./exec-approvals-D-0O95K3.js";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-BBr3nqAS.js";
import { t as parseAbsoluteTimeMs } from "./parse-DqAvJRIf.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-D4DZ8-Da.js";
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-BymIjgvL.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-DzJUWmKf.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-Nq83EHH9.js";
import "./daemon-runtime-CdRkJHnu.js";
import { c as loadAgentIdentity, d as loadAgentIdentityFromWorkspace, i as applyAgentConfig, l as pruneAgentConfig, o as findAgentEntryIndex, p as forceFreePortAndWait, r as getStatusSummary, s as listAgentEntries, t as runOnboardingWizard } from "./onboarding-C7zhX_Kp.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-BMCIHKoi.js";
import "./logging-B1-_zaW-.js";
import "./note-DVO1KLaW.js";
import { t as WizardCancelledError } from "./prompts--d-6l5Ln.js";
import { i as discoverGatewayBeacons, n as installSkill } from "./onboard-skills-DAyOQGKO.js";
import "./github-copilot-auth-DHzyGjwQ.js";
import "./onboard-channels-DBK8gZQE.js";
import { r as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-MImqCtu1.js";
import "./archive-CXhvR9nU.js";
import "./skill-scanner-BuJ49HsN.js";
import "./installs-CHydtYsj.js";
import { a as resolveControlUiRootOverrideSync, c as getHealthSnapshot, d as runHeartbeatOnce, f as setHeartbeatsEnabled, n as ensureControlUiAssetsBuilt, o as resolveControlUiRootSync, p as startHeartbeatRunner, s as formatHealthChannelLines } from "./health-format-Ftqhn95v.js";
import { S as normalizeUpdateChannel, t as runGatewayUpdate } from "./update-runner-COolrwtD.js";
import { i as resolveGatewayAuth, n as authorizeGatewayConnect, r as isLocalDirectRequest, t as assertGatewayAuthConfigured } from "./auth-DGLKfFAP.js";
import { i as probeGateway } from "./audit-DQQvOoH0.js";
import "./table-DNHcipJn.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-guzspUwV.js";
import "./service-DOlJdIqe.js";
import "./systemd-Pa7LURHB.js";
import "./service-audit-Kr_mOIq8.js";
import "./node-service-DQ-tiSie.js";
import "./channels-status-issues-B8Xmi4Xt.js";
import "./completion-cli-BqD_jRKw.js";
import { a as createOutboundSendDeps$1, i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-Dt8zZiwd.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-D2rfvnyE.js";
import { i as shouldIncludeHook, n as loadWorkspaceHookEntries, r as resolveHookConfig } from "./hooks-status-CqTwk2h3.js";
import "./tui-D2JSZ-pa.js";
import { t as buildChannelAccountSnapshot } from "./status-Cv36yYdi.js";
import "./shared-B5iu5I9Y.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-Dw3GgRRB.js";
import { a as toOptionString, i as parsePort$1, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-BnpC3wMU.js";
import { i as setGatewayWsLogStyle, n as logWs, r as summarizeAgentEventForWsLog, t as formatForLog } from "./ws-log-Di6Fn6rw.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-oBPvPyDe.js";
...
function scheduleGatewayUpdateCheck(params) {
	(/* @__PURE__ */ runGatewayUpdateCheck(params)).catch(() => {});
}
...
const FIELD_LABELS = {
	...
	"agents.defaults.extraBootstrapFiles": "Extra Bootstrap Files",
...
const FIELD_HELP = {
	...
	"agents.defaults.extraBootstrapFiles": "Additional .md files from workspace dir loaded into the system prompt after MEMORY.md (max 5, flat names only, no paths).",
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BufhgQF0.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		const { loadSessionLogs } = await import("./session-cost-usage-BLg4_A0k.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-BBr3nqAS.js").then((n) => n.t);
