...
import { Tt as resolveCommitHash, Wt as createDefaultDeps, t as getReplyFromConfig } from "./reply-B71GWwIQ.js";
...
import { r as normalizeEnv, t as isTruthyEnvValue } from "./env-DkKx0PT3.js";
import "./host-env-security-ljCLeQmh.js";
import "./message-channel-C8Keu0lE.js";
import "./send-K9smqp-y.js";
import { Mt as loadDotEnv, i as loadConfig } from "./config-DNKWBHAH.js";
import { r as VERSION } from "./env-vars-CvvqezS9.js";
import "./manifest-registry-C6u54rI3.js";
import "./dock-ivyty9f-.js";
import { _ as applyTemplate, u as installUnhandledRejectionHandler } from "./runner-BEGrwMIi.js";
...
import { l as ensureBinary, u as promptYesNo } from "./tailscale-iTlFoOvr.js";
...
import { r as formatUncaughtError } from "./errors-DiV2hVgY.js";
...
import { i as handlePortError, n as describePortOwner, r as ensurePortAvailable, t as PortInUseError } from "./ports-CMYOQ1Xv.js";
import "./server-middleware-CQ0JmE7W.js";
import { B as resolveSessionKey, c as loadSessionStore, p as saveSessionStore, z as deriveSessionKey } from "./sessions-BVFFX_jz.js";
...
import { r as waitForever, t as monitorWebChannel } from "./channel-web-V06aL5WK.js";
...
import { i as getCoreCliCommandsWithSubcommands, n as setProgramContext, o as registerProgramCommands, s as getSubCliCommandsWithSubcommands } from "./program-context-MlR3BGP2.js";
import "./catalog-DSCBeNDx.js";
import "./plugin-registry-Bww09KTQ.js";
import { n as resolveCliChannelOptions } from "./channel-options-BORElZ7r.js";
...
function registerPreActionHooks(program, programVersion) {
	program.hook("preAction", async (_thisCommand, actionCommand) => {
		...
		const { ensureConfigReady } = await import("./config-guard-CJRBx9F6.js");
		await ensureConfigReady({
			runtime: defaultRuntime,
			commandPath
		});
		if (PLUGIN_REQUIRED_COMMANDS.has(commandPath[0])) {
			const { ensurePluginRegistryLoaded } = await import("./plugin-registry-Bww09KTQ.js").then((n) => n.n);
