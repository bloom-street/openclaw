...
import { Ct as formatControlUiSshHint, D as runMessageAction, Et as moveToTrash, Ft as waitForGatewayReachable, I as CHANNEL_MESSAGE_ACTION_NAMES, Mt as resolveControlUiLinks, Ot as openUrl, P as formatTargetDisplay, St as ensureWorkspaceAndSessions, Tt as handleReset, Ur as applyTemplate, an as registerMemoryCli, at as CHANNEL_TARGETS_DESCRIPTION, fn as waitForever, ht as resolveCommitHash, jt as randomToken, on as runMemoryStatus, ot as CHANNEL_TARGET_DESCRIPTION, sn as monitorWebChannel, t as getReplyFromConfig, un as installUnhandledRejectionHandler, vt as DEFAULT_WORKSPACE, xr as lookupContextTokens, xt as detectBrowserOpenSupport, yt as applyWizardMetadata } from "./reply-DptDUVRg.js";
...
import { D as resolveSessionKey, E as deriveSessionKey, d as loadSessionStore, m as saveSessionStore } from "./sandbox-DiYTfhXZ.js";
...
import { t as createDefaultDeps } from "./deps-CuMbwymE.js";
...
import { a as buildAgentSummaries, c as loadAgentIdentity, f as parseIdentityMarkdown, i as applyAgentConfig, l as pruneAgentConfig, n as statusCommand, o as findAgentEntryIndex, s as listAgentEntries, t as runOnboardingWizard, u as identityHasValues } from "./onboarding-JiSpdgp0.js";
...
import { d as warnIfModelConfigLooksOff, f as applyAuthChoice, g as promptAuthChoiceGrouped, h as applyGoogleGeminiModelDefault, m as upsertSharedEnvVar, p as applyOpenAIConfig } from "./onboard-skills-mB8B_tSl.js";
...
import { l as healthCommand } from "./health-format-C-6Pxyam.js";
import "./update-runner-w7hzKQTW.js";
import "./auth-DWzhQMLZ.js";
import "./audit-BGCC2cOn.js";
...
import { c as registerSubCliCommands, d as getPositiveIntFlagValue, f as getVerboseFlag, l as getCommandPath, m as hasHelpOrVersion, p as hasFlag, u as getFlagValue } from "./completion-cli-CdNoCZaG.js";
...
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-urroxZBf.js";
import { i as hasExplicitOptions, n as resolveCliChannelOptions, r as ensurePluginRegistryLoaded } from "./channel-options-B_zYwhZ-.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-CRzoyyXS.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-BhUrP1RU.js";
...
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-DYyapZaP.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-BhUrP1RU.js").then((n) => n.t);
