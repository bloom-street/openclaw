...
import { Ct as formatControlUiSshHint, D as runMessageAction, Et as moveToTrash, Ft as waitForGatewayReachable, I as CHANNEL_MESSAGE_ACTION_NAMES, Mt as resolveControlUiLinks, Ot as openUrl, P as formatTargetDisplay, St as ensureWorkspaceAndSessions, Tt as handleReset, Ur as applyTemplate, an as registerMemoryCli, at as CHANNEL_TARGETS_DESCRIPTION, fn as waitForever, ht as resolveCommitHash, jt as randomToken, on as runMemoryStatus, ot as CHANNEL_TARGET_DESCRIPTION, sn as monitorWebChannel, t as getReplyFromConfig, un as installUnhandledRejectionHandler, vt as DEFAULT_WORKSPACE, xr as lookupContextTokens, xt as detectBrowserOpenSupport, yt as applyWizardMetadata } from "./reply-CUwCtVzh.js";
...
import { c as writeConfigFile, h as parseDurationMs, i as loadConfig, j as VERSION, o as readConfigFileSnapshot, r as createConfigIO } from "./config-DE7StXS1.js";
...
import { D as resolveSessionKey, E as deriveSessionKey, d as loadSessionStore, m as saveSessionStore } from "./sandbox-C2s8_C_t.js";
import "./image-CSx7jj7z.js";
import "./pi-model-discovery-CV2V1HHz.js";
import { c as describePortOwner, l as ensurePortAvailable, s as PortInUseError, u as handlePortError } from "./chrome-DI--0Dvj.js";
...
import { i as randomIdempotencyKey, n as callGateway } from "./call-Ch49AeEh.js";
...
import { t as createDefaultDeps } from "./deps-BymIjgvL.js";
...
import { a as gatewayInstallErrorHint, g as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CdRkJHnu.js";
import { a as buildAgentSummaries, c as loadAgentIdentity, f as parseIdentityMarkdown, i as applyAgentConfig, l as pruneAgentConfig, n as statusCommand, o as findAgentEntryIndex, s as listAgentEntries, t as runOnboardingWizard, u as identityHasValues } from "./onboarding-C7zhX_Kp.js";
...
import { c as registerSubCliCommands, d as getPositiveIntFlagValue, f as getVerboseFlag, l as getCommandPath, m as hasHelpOrVersion, p as hasFlag, u as getFlagValue } from "./completion-cli-BqD_jRKw.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-COv3Vtqw.js";
import { t as formatHelpExamples } from "./help-format-aiW76js8.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-Dt8zZiwd.js";
import { i as hasExplicitOptions, n as resolveCliChannelOptions, r as ensurePluginRegistryLoaded } from "./channel-options-CIRMtWk4.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-CRzoyyXS.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-BFYJ12yI.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-6_naJcJp.js";
import "./widearea-dns-D2rfvnyE.js";
import "./auth-health-CcTiqY4G.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-CLo3cGDI.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-BFYJ12yI.js").then((n) => n.t);
