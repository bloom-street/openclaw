import { _ as resolveUserPath, c as ensureDir, l as escapeRegExp, m as resolveConfigDir, t as CONFIG_DIR } from "./utils-DC1T2Vz-.js";
import { Nt as resolveNodeManagerOptions, Ot as openUrl, bt as detectBinary, kr as loadModelCatalog } from "./reply-CUwCtVzh.js";
import { t as runCommandWithTimeout } from "./exec-DFOtZbI0.js";
import { a as resolveAgentModelPrimary, c as resolveDefaultAgentId, r as resolveAgentDir, s as resolveAgentWorkspaceDir, w as resolveDefaultAgentWorkspaceDir } from "./agent-scope-TEKvyC71.js";
import { D as VENICE_DEFAULT_MODEL_REF, F as getCustomProviderApiKey, Tt as DEFAULT_PROVIDER, Z as resolveAuthProfileOrder, _t as resolveOpenClawAgentDir, at as generateChutesPkce, ct as listProfilesForProvider, d as resolveConfiguredModelRef, dt as upsertAuthProfile, ft as ensureAuthProfileStore, it as exchangeChutesCodeForTokens, j as SYNTHETIC_DEFAULT_MODEL_REF, o as modelKey, ot as parseOAuthCallbackInput, q as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, r as buildModelAliasIndex, rt as CHUTES_AUTHORIZE_ENDPOINT, s as normalizeProviderId, t as buildAllowedModelSet, u as resolveAllowlistModelKey, wt as DEFAULT_MODEL, yt as normalizeSecretInput, z as resolveEnvApiKey } from "./model-selection-BSjmwr-2.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import { _ as resolveSkillKey, d as hasBinary, i as loadWorkspaceSkillEntries, t as resolveSkillsInstallPreferences } from "./skills-BpAg7sFB.js";
import { X as fetchWithSsrFGuard } from "./deliver-DZFwPB6N.js";
...
import { a as enablePluginInConfig } from "./onboard-channels-DBK8gZQE.js";
import { t as scanDirectoryWithSummary } from "./skill-scanner-BuJ49HsN.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-guzspUwV.js";
import { n as resolveWideAreaDiscoveryDomain } from "./widearea-dns-D2rfvnyE.js";
...
//#endregion
export { applyModelAllowlist as a, promptDefaultModel as c, warnIfModelConfigLooksOff as d, applyAuthChoice as f, promptAuthChoiceGrouped as g, applyGoogleGeminiModelDefault as h, discoverGatewayBeacons as i, promptModelAllowlist as l, upsertSharedEnvVar as m, installSkill as n, applyModelFallbacksFromSelection as o, applyOpenAIConfig as p, promptRemoteGatewayConfig as r, applyPrimaryModel as s, setupSkills as t, resolvePreferredProviderForAuthChoice as u };