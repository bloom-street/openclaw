import { n as resolveAgentConfig, u as resolveSessionAgentId } from "./agent-scope-Cn3C2ptS.js";
...
import { c as SafeOpenError, i as getImageMetadata, l as openFileWithinRoot, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-BeXtPfpf.js";
import { _ as getBlockedNetworkModeReason, n as loadConfig, o as writeConfigFile, t as createConfigIO } from "./config-BB8kMxZU.js";
...
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-DWsO7kgP.js";
...
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-C9BdIBuE.js";
import { R as canonicalizeMainSessionAlias, W as acquireSessionWriteLock, z as resolveAgentMainSessionKey } from "./sessions-DKdDjs2z.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-CSJmog7A.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CAHu0aJS.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-CAHu0aJS.js")).closePlaywrightBrowserConnection();
		} catch {}
