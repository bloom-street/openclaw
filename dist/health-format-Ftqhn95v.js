import { D as info, I as colorize, L as isRich, R as theme, c as defaultRuntime, t as createSubsystemLogger } from "./subsystem-DPnkvS73.js";
import { A as resolveHeartbeatDeliveryTarget, Kn as resolveUserTimezone, Or as peekSystemEvents, Un as resolveEffectiveMessagesConfig, _r as DEFAULT_HEARTBEAT_EVERY, br as stripHeartbeatToken, ct as setHeartbeatWakeHandler, fr as CommandLane, gr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, hn as emitHeartbeatEvent, j as resolveHeartbeatSenderContext, mn as resolveHeartbeatVisibility, st as requestHeartbeatNow, t as getReplyFromConfig, ur as getQueueSize, vn as resolveIndicatorType, vr as isHeartbeatContentEffectivelyEmpty, yr as resolveHeartbeatPrompt$1 } from "./reply-CUwCtVzh.js";
import { d as resolveAgentIdFromSessionKey, h as toAgentStoreSessionKey, l as normalizeAgentId } from "./session-key-CUWZSMYQ.js";
...
import { c as resolveDefaultAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, s as resolveAgentWorkspaceDir } from "./agent-scope-TEKvyC71.js";
import { t as isTruthyEnvValue } from "./env-B5YXooWp.js";
import { h as parseDurationMs, i as loadConfig } from "./config-DE7StXS1.js";
import { f as resolvePreferredAccountId, n as listChannelPlugins, t as getChannelPlugin, u as buildChannelAccountBindings } from "./plugins-Dyk3sGJx.js";
import { F as resolveAgentMainSessionKey, P as canonicalizeMainSessionAlias, d as loadSessionStore, g as updateSessionStore, m as saveSessionStore } from "./sandbox-C2s8_C_t.js";
import { n as formatErrorMessage } from "./errors-BTWUcKZ6.js";
import { o as resolveStorePath } from "./paths-BuajeM4x.js";
import { G as HEARTBEAT_TOKEN, t as deliverOutboundPayloads } from "./deliver-DZFwPB6N.js";
...
async function runHeartbeatOnce(opts) {
	...
	const ctx = {
		Body: hasExecCompletion ? EXEC_EVENT_PROMPT : hasCronEvents ? CRON_EVENT_PROMPT : resolveHeartbeatPrompt(cfg, heartbeat),
		From: sender,
		To: sender,
