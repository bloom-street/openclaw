...
import { A as resolveAgentModelFallbackValues, M as toAgentModelListLike, O as resolveDefaultAgentWorkspaceDir, i as resolveAgentDir, j as resolveAgentModelPrimaryValue, l as resolveAgentWorkspaceDir, o as resolveAgentExplicitModelPrimary, s as resolveAgentModelFallbacksOverride, u as resolveDefaultAgentId } from "./agent-scope-Coy2hU9C.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./pi-auth-json-DLY46k-m.js";
import { r as resolveForwardCompatModel } from "./model-PL9Vv3mu.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-CwESh4K1.js";
import { T as parseDurationMs, i as loadConfig } from "./config-8-je4WFT.js";
import { Qt as formatRemainingShort, Xt as DEFAULT_OAUTH_WARN_MS, Yt as maskApiKey, Zt as buildAuthHealthSummary, gn as resolveUsageProviderId, hn as formatUsageWindowSummary, pn as loadProviderUsageSummary, s as runEmbeddedPiAgent, yt as describeFailoverError } from "./subagent-registry-Cl20Qbu_.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-Dvmk_rXi.js";
import { t as ensureOpenClawModelsJson } from "./models-config-C5xBkghi.js";
import { n as loadModelCatalog } from "./model-catalog-CpS_x7oW.js";
import { r as withProgressTotals } from "./progress-NYYdD1uh.js";
import { f as openUrl } from "./onboard-helpers-DrCs3JdA.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-BjGBBTZh.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-BOEwUWxO.js";
import { n as logConfigUpdated } from "./logging-2pVgGvge.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-DvF5ukpB.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureAuthProfileStore } = await import("./auth-profiles-D22D1tnt.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-PL9Vv3mu.js").then((n) => n.t);
