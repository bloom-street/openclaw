...
const entries = [
	...
	},
	{
		...
		register: async (program) => {
			(await import("./gateway-cli-BwUj3dQB.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
		...
		register: async (program) => {
			(await import("./daemon-cli-DvlJGD3U.js").then((n) => n.t)).registerDaemonCli(program);
		}
	},
	{
		name: "logs",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./models-cli-B9Ft2kHG.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./sandbox-cli-D_qwaMFe.js")).registerSandboxCli(program);
		}
	},
	{
		name: "tui",
		...
		register: async (program) => {
			(await import("./tui-cli-Dc09LQvA.js")).registerTuiCli(program);
		}
	},
	{
		name: "cron",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./hooks-cli-qZ0LBVG4.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
	...
	},
	{
		...
		register: async (program) => {
			const { registerPluginCliCommands } = await import("./cli-B-qQkM7Z.js");
	...
	},
	{
		...
		register: async (program) => {
			(await import("./plugins-cli-C7rUAHme.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-B-qQkM7Z.js");
			registerPluginCliCommands(program, await loadConfig());
		}
	},
	{
		...
		register: async (program) => {
			(await import("./channels-cli-CxjkPuql.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./security-cli-dTEL1lR4.js")).registerSecurityCli(program);
		}
	},
	{
		name: "skills",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./update-cli-D1afM11U.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
