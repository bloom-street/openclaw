...
import { _ as resolveUserPath } from "./utils-DC1T2Vz-.js";
import { n as DEFAULT_AGENT_ID } from "./session-key-CUWZSMYQ.js";
import { a as resolveAgentModelPrimary } from "./agent-scope-BimPHsgV.js";
...
//#endregion
export { markAuthProfileFailure as $, SYNTHETIC_BASE_URL as A, resolveModelAuthMode as B, resolveImplicitBedrockProvider as C, DEFAULT_CONTEXT_TOKENS as Ct, VENICE_DEFAULT_MODEL_REF as D, VENICE_BASE_URL as E, getCustomProviderApiKey as F, shouldDeferShellEnvFallback as G, getShellPathFromLoginShell as H, requireApiKey as I, buildCloudflareAiGatewayModelDefinition as J, shouldEnableShellEnvFallback as K, resolveApiKeyForProvider as L, SYNTHETIC_MODEL_CATALOG as M, buildSyntheticModelDefinition as N, VENICE_MODEL_CATALOG as O, getApiKeyForModel as P, isProfileInCooldown as Q, resolveAwsSdkEnvVarName as R, normalizeProviders as S, CODEX_CLI_PROFILE_ID as St, resolveImplicitProviders as T, DEFAULT_PROVIDER as Tt, loadShellEnvFallback as U, getShellEnvAppliedKeys as V, resolveShellEnvFallbackTimeoutMs as W, auth_profiles_exports as X, resolveCloudflareAiGatewayBaseUrl as Y, resolveAuthProfileOrder as Z, QIANFAN_DEFAULT_MODEL_ID as _, resolveOpenClawAgentDir as _t, isCliProvider as a, generateChutesPkce as at, buildXiaomiProvider as b, resolveAuthProfileDisplayLabel as bt, parseModelRef as c, listProfilesForProvider as ct, resolveConfiguredModelRef as d, upsertAuthProfile as dt, markAuthProfileUsed as et, resolveDefaultModelForAgent as f, ensureAuthProfileStore as ft, QIANFAN_BASE_URL as g, resolveAuthStorePathForDisplay as gt, resolveThinkingDefault as h, resolveAuthStorePath as ht, getModelRefStatus as i, exchangeChutesCodeForTokens as it, SYNTHETIC_DEFAULT_MODEL_REF as j, buildVeniceModelDefinition as k, resolveAllowedModelRef as l, markAuthProfileGood as lt, resolveModelRefFromString as m, updateAuthProfileStoreWithLock as mt, buildConfiguredAllowlistKeys as n, resolveApiKeyForProfile as nt, modelKey as o, parseOAuthCallbackInput as ot, resolveHooksGmailModel as p, loadAuthProfileStore as pt, CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF as q, buildModelAliasIndex as r, CHUTES_AUTHORIZE_ENDPOINT as rt, normalizeProviderId as s, repairOAuthProfileIdMismatch as st, buildAllowedModelSet as t, resolveProfileUnusableUntilForDisplay as tt, resolveAllowlistModelKey as u, setAuthProfileOrder as ut, XIAOMI_DEFAULT_MODEL_ID as v, normalizeOptionalSecretInput as vt, resolveImplicitCopilotProvider as w, DEFAULT_MODEL as wt, normalizeGoogleModelId as x, CLAUDE_CLI_PROFILE_ID as xt, buildQianfanProvider as y, normalizeSecretInput as yt, resolveEnvApiKey as z };