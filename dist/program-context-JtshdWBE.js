...
const entries = [
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./gateway-cli-Ku7EZJRM.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./update-cli-CLyAxei8.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./completion-cli-CaRWNzMd.js").then((n) => n.n)).registerCompletionCli(program);
		}
	}
];
...
const coreEntries = [
	{
		...
		register: async ({ program }) => {
			(await import("./register.setup-BHPhg6TU.js")).registerSetupCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.onboard-DrMvo-Uq.js")).registerOnboardCommand(program);
		}
	},
	{
		commands: [{
	...
	},
	{
		...
		register: async ({ program }) => {
			(await import("./register.maintenance-BiIh11_D.js")).registerMaintenanceCommands(program);
		}
	},
	{
		commands: [{
