...
import { c as resolveDefaultAgentId, f as DEFAULT_AGENT_WORKSPACE_DIR, h as DEFAULT_IDENTITY_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, w as resolveDefaultAgentWorkspaceDir, x as ensureAgentWorkspace } from "./agent-scope-BPbP3nUY.js";
import { c as writeConfigFile, h as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-DWFc1sJR.js";
import { n as movePathToTrash } from "./server-context-Di_oV8Uv.js";
import { i as randomIdempotencyKey, n as callGateway } from "./call-AlDhuZZQ.js";
...
import { d as loadSessionStore } from "./sandbox-BE3PG9bB.js";
import { n as formatTimeAgo } from "./format-relative-79_Y1n2Y.js";
import { n as runCommandWithRuntime } from "./cli-utils-PlLcDZlM.js";
import { n as ensurePluginRegistryLoaded, t as hasExplicitOptions } from "./command-options-DhbsFK9n.js";
import { l as getVerboseFlag, o as getFlagValue, r as registerSubCliCommands, s as getPositiveIntFlagValue, u as hasFlag } from "./register.subclis-D_ovGplK.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-CQI-5xS9.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-C1hgTUEu.js";
import { t as createDefaultDeps } from "./deps-CsJlqqD0.js";
import { a as gatewayInstallErrorHint, h as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-D359XoF_.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-CnormYb3.js").then((n) => n.t);
