...
const entries = [
	...
	},
	{
		...
		register: async (program) => {
			(await import("./gateway-cli-BqSw77hM.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
		...
		register: async (program) => {
			(await import("./daemon-cli-BNcCYt0s.js").then((n) => n.t)).registerDaemonCli(program);
		}
	},
	{
		name: "logs",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./models-cli-CtaEInr7.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./hooks-cli-b37ceMtv.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
	...
	},
	{
		...
		register: async (program) => {
			const { registerPluginCliCommands } = await import("./cli-BSGhPLzE.js");
	...
	},
	{
		...
		register: async (program) => {
			(await import("./plugins-cli-DzGQ4PBz.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-BSGhPLzE.js");
			registerPluginCliCommands(program, await loadConfig());
		}
	},
	{
		...
		register: async (program) => {
			(await import("./channels-cli-V7JOg2Q2.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
	...
	},
	{
		...
		register: async (program) => {
			(await import("./update-cli-YYnSAG5b.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		register: async (program) => {
			(await import("./completion-cli-CYvvCJ5Z.js").then((n) => n.n)).registerCompletionCli(program);
		}
	}
];
