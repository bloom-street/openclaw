...
import { Rt as resolveOpenClawAgentDir } from "./model-selection-DooR7GQG.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-CqD62Qe8.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
