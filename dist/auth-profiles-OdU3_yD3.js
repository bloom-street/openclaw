...
import { n as DEFAULT_AGENT_ID } from "./session-key-BRdRr5Ah.js";
import { g as resolveUserPath } from "./utils-kK6fjsN0.js";
import { a as resolveAgentModelPrimary } from "./agent-scope-BPbP3nUY.js";
...
//#endregion
export { SYNTHETIC_DEFAULT_MODEL_REF as $, parseModelRef as A, XIAOMI_DEFAULT_MODEL_ID as B, buildAllowedModelSet as C, resolveAuthProfileDisplayLabel as Ct, isCliProvider as D, getModelRefStatus as E, resolveHooksGmailModel as F, resolveImplicitBedrockProvider as G, buildXiaomiProvider as H, resolveModelRefFromString as I, VENICE_BASE_URL as J, resolveImplicitCopilotProvider as K, resolveThinkingDefault as L, resolveAllowlistModelKey as M, resolveConfiguredModelRef as N, modelKey as O, resolveDefaultModelForAgent as P, SYNTHETIC_BASE_URL as Q, QIANFAN_BASE_URL as R, resolveOpenClawAgentDir as S, DEFAULT_PROVIDER as St, buildModelAliasIndex as T, CODEX_CLI_PROFILE_ID as Tt, normalizeGoogleModelId as U, buildQianfanProvider as V, normalizeProviders as W, VENICE_MODEL_CATALOG as X, VENICE_DEFAULT_MODEL_REF as Y, buildVeniceModelDefinition as Z, ensureAuthProfileStore as _, CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF as _t, markAuthProfileUsed as a, resolveApiKeyForProvider as at, resolveAuthStorePath as b, DEFAULT_CONTEXT_TOKENS as bt, CHUTES_AUTHORIZE_ENDPOINT as c, resolveModelAuthMode as ct, parseOAuthCallbackInput as d, getShellEnvAppliedKeys as dt, SYNTHETIC_MODEL_CATALOG as et, repairOAuthProfileIdMismatch as f, getShellPathFromLoginShell as ft, upsertAuthProfile as g, shouldEnableShellEnvFallback as gt, setAuthProfileOrder as h, shouldDeferShellEnvFallback as ht, markAuthProfileFailure as i, requireApiKey as it, resolveAllowedModelRef as j, normalizeProviderId as k, exchangeChutesCodeForTokens as l, normalizeOptionalSecretInput as lt, markAuthProfileGood as m, resolveShellEnvFallbackTimeoutMs as mt, resolveAuthProfileOrder as n, getApiKeyForModel as nt, resolveProfileUnusableUntilForDisplay as o, resolveAwsSdkEnvVarName as ot, listProfilesForProvider as p, loadShellEnvFallback as pt, resolveImplicitProviders as q, isProfileInCooldown as r, getCustomProviderApiKey as rt, resolveApiKeyForProfile as s, resolveEnvApiKey as st, auth_profiles_exports as t, buildSyntheticModelDefinition as tt, generateChutesPkce as u, normalizeSecretInput as ut, loadAuthProfileStore as v, buildCloudflareAiGatewayModelDefinition as vt, buildConfiguredAllowlistKeys as w, CLAUDE_CLI_PROFILE_ID as wt, resolveAuthStorePathForDisplay as x, DEFAULT_MODEL as xt, updateAuthProfileStoreWithLock as y, resolveCloudflareAiGatewayBaseUrl as yt, QIANFAN_DEFAULT_MODEL_ID as z };