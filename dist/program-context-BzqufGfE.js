...
const loadConfig = async () => {
	return (await import("./config-DNKWBHAH.js").then((n) => n.t)).loadConfig();
};
const entries = [
	{
		name: "acp",
		...
		register: async (program) => {
			(await import("./acp-cli-B7p90zOI.js")).registerAcpCli(program);
		}
	},
	{
		name: "gateway",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./gateway-cli-BvYW26kR.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./daemon-cli-DHlx2DEJ.js").then((n) => n.t)).registerDaemonCli(program);
		}
	},
	{
		name: "logs",
		...
		register: async (program) => {
			(await import("./logs-cli-B82NEUmf.js")).registerLogsCli(program);
		}
	},
	{
		name: "system",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./system-cli-C7qGlbWB.js")).registerSystemCli(program);
		}
	},
	{
		name: "models",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./models-cli-DowRuBGC.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./exec-approvals-cli-DAMK3bnX.js")).registerExecApprovalsCli(program);
		}
	},
	{
		name: "nodes",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./nodes-cli-DSXxixxB.js")).registerNodesCli(program);
		}
	},
	{
		name: "devices",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./devices-cli-Bo08qrC-.js")).registerDevicesCli(program);
		}
	},
	{
		name: "node",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./node-cli-BPKIeSQu.js")).registerNodeCli(program);
		}
	},
	{
		name: "sandbox",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./sandbox-cli-DW8lqEGQ.js")).registerSandboxCli(program);
		}
	},
	{
		name: "tui",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./tui-cli-Bx5KqmBO.js")).registerTuiCli(program);
		}
	},
	{
		name: "cron",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./cron-cli-DqANmLit.js")).registerCronCli(program);
		}
	},
	{
		name: "dns",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./dns-cli-B56a3f0v.js")).registerDnsCli(program);
		}
	},
	{
		name: "docs",
	...
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./hooks-cli-B5ht2IVc.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./webhooks-cli-Dr0a8ZUe.js")).registerWebhooksCli(program);
		}
	},
	{
		name: "qr",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./qr-cli-DtLQAkRW.js").then((n) => n.t)).registerQrCli(program);
		}
	},
	{
		name: "clawbot",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./clawbot-cli-BQUS5pSj.js")).registerClawbotCli(program);
		}
	},
	{
		name: "pairing",
		...
		hasSubcommands: true,
		register: async (program) => {
			const { registerPluginCliCommands } = await import("./cli-BVZTbQA3.js");
			registerPluginCliCommands(program, await loadConfig());
			(await import("./pairing-cli-BBPYO5hg.js")).registerPairingCli(program);
		}
	},
	{
		name: "plugins",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./plugins-cli-Cu_2C2fZ.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-BVZTbQA3.js");
			registerPluginCliCommands(program, await loadConfig());
		}
	},
	{
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./channels-cli-BbmCFxWA.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./directory-cli-CLbHp1U_.js")).registerDirectoryCli(program);
		}
	},
	{
		name: "security",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./security-cli-BwRG6yd1.js")).registerSecurityCli(program);
		}
	},
	{
		name: "skills",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./skills-cli-QGkFLAJg.js")).registerSkillsCli(program);
		}
	},
	{
		name: "update",
		...
		hasSubcommands: true,
		register: async (program) => {
			(await import("./update-cli-BAO8GCOg.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		hasSubcommands: false,
		register: async (program) => {
			(await import("./completion-cli-Bk_Al9GV.js").then((n) => n.n)).registerCompletionCli(program);
		}
	}
];
...
const coreEntries = [
	{
		...
		register: async ({ program }) => {
			(await import("./register.setup-DzGIAJUq.js")).registerSetupCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.onboard-DwXdvIe9.js")).registerOnboardCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./register.configure-BYb4Gnrg.js")).registerConfigureCommand(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./config-cli-DuGsFctL.js")).registerConfigCli(program);
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.maintenance-C0JRQi1r.js")).registerMaintenanceCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.message-CxNGtWrY.js")).registerMessageCommands(program, ctx);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./memory-cli-CjaBzQyD.js").then((n) => n.t)).registerMemoryCli(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program, ctx }) => {
			(await import("./register.agent-48RNFZnq.js")).registerAgentCommands(program, { agentChannelOptions: ctx.agentChannelOptions });
		}
	},
	{
		commands: [
		...
		register: async ({ program }) => {
			(await import("./register.status-health-sessions-jymhwnVf.js")).registerStatusHealthSessionsCommands(program);
		}
	},
	{
		commands: [{
		...
		register: async ({ program }) => {
			(await import("./browser-cli-DJm6br0q.js")).registerBrowserCli(program);
		}
	}
];
